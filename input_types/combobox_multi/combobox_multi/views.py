...
from combobox_multi.models import Combobox
...
def index(request):
    ...
    return render(request, 'combobox_multi/index.html', {'html': html, 'listar_combos': listar_combos})
...
def enviar(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'combobox_multi/index.html', {'html': html, 'combo': combo, 'listar_combos':listar_combos})
