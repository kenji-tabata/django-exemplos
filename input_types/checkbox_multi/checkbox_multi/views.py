...
from checkbox_multi.models import Check
...
def index(request):
    ...
    return render(request, 'checkbox_multi/index.html', {'checkboxes': checkboxes, 'lista': lista})
...
def enviar(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'checkbox_multi/index.html', {'resp': resp, 'checkboxes': checkboxes, 'lista': lista})
    
    elif request.method == 'GET':
        return render(request, 'checkbox_multi/index.html', {'checkboxes': checkboxes})
