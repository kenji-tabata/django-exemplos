...
class TransportesTest(TestCase):
    ...
    def test_enviar_checkbox_multi_selecionados(self):
        client = Client()
        check1 = client.post('/checkbox_multi/enviar/', {'carro':'Sim','moto':'Não','onibus':'Sim','bicicleta':'Sim'})
        check2 = client.post('/checkbox_multi/enviar/', {'carro':'Sim','onibus':'Sim','bicicleta':'Sim'})
        check3 = client.post('/checkbox_multi/enviar/', {'moto':'Não','onibus':'Sim'})
        check4 = client.post('/checkbox_multi/enviar/', {'onibus':'Sim'})
        check5 = client.post('/checkbox_multi/enviar/', {})
        check6 = client.post('/checkbox_multi/enviar', {})
        check7 = client.get('/checkbox_multi/enviar/')
