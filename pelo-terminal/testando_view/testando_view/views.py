...
from testando_view.forms import ContatoForm

def index(request):
    contatos = Contato.objects.order_by('-id')
    print('Listar todos os contatos')
    return render(request, 'testando_view/index.html', {'contatos': contatos})


def adicionar(request):
    form = ContatoForm()
    print('Adicionar Contato')
    return render(request, 'testando_view/adicionar.html', {'form': form})
...
def enviar(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('testando_view.views.detalhes', pk=contato.pk) 
        else:
...
def editar(request, pk):
    ...
    return render(request, 'testando_view/editar.html', {'form': form})        
...
def deletar(request, pk):
    ...
    return redirect('testando_view.views.index')
...
def detalhes(request, pk):
    ...
    return render(request, 'testando_view/detalhes.html', {'contato': contato})
