...
from d10_checkbox_multi.models import Check
...
def index(request):
    ...
    return render(request, 'd10_checkbox_multi/index.html', {'checkboxes': checkboxes})
...
def enviar(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'd10_checkbox_multi/index.html', {'checkboxes': checkboxes, 'resp': resp})
